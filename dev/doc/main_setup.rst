...
To create it locally, clone the repositories, get the dependencies via Maven and build the jar. You need to take care of the java version, you are using. Find more information on the :ref:`contrib_start`.
